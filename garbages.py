...
Indian
 'Temples</u>,', '<u>', '<br/>
 , '<br/>', '<br/>', '</u>,', '<u>Indian', 'Temple',
 Architecture', '</u>,', '<u>Travel', 'Tourism</u>,', '<u>', '<br/>', '</u>,', '<u>Festivals', 'Fairs</u>,', '<u>', '<br/>', '</u>,', '<u>Myths', 'Legends</u>,', '<u><br/>', '</u>,', '<u>Glossary', 'Terms', '</u>,', 'To', '', '', '', '', '', '', '', '', '', 'site', 'information,', 'contact:,', '', '<br/>', ',', 'webmaster@templenet.com,', '', ',', 'Â©1996', '', '', '', '', '', '', '', '', '', 'K.', 'Kannikeswaran', '<br/>', '', '', '', '', '', '', '', '', '', 'All', 'Rights', 'Reserved.', ',', 'This', 'site', '', '', '', '', '', '', '', '', '', 'created', ',', 'Heritage', 'Net', '', '', '', '', '', '', '', '', '', 'Associates,', 'where,', '<i>Tradition', '', '', '', '', '', '', '', '', '', 'Meets', 'Technology</i>,', 'Hosted', '', '', '', '', '', '', '', '', '', 'Blueshift', 'Inc.,', 'The', 'Templenet', 'Encyclopedia', '-', 'Temples', ',', 'West', 
...
temple 
  in kolkata 
List of Temples top      in   
List of Temples     images 
List of Temples     list 
u
k
"""
import re
...
wordmfile = ("{}{}{}".format(worddatamasterdir,N,"garbage_master.csv"))
